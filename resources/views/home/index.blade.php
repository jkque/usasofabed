	...
	<section id="slider" class="slider-parallax revslider-wrap ohidden clearfix">
		...
		<div class="tp-banner-container">
			...
			<li data-transition="fade" data-slotamount="1" data-masterspeed="1500" data-delay="10000" data-saveperformance="off" data-title="Latest Collections" style="background-color: #F6F6F6;">
				...
				data-endspeed="1000"
				data-endeasing="Power4.easeIn" style=""><img src="{{asset('assets/images/sliders/sofa1.png')}}" alt="Sofa"></div>
				...
				data-endelementdelay="0.1"
				data-endspeed="1000"
				data-endeasing="Power4.easeIn" style=" color: #333;">Get your Sofa Beds Ready</div>
				...
				data-endelementdelay="0.1"
				data-endspeed="1000"
				data-endeasing="Power4.easeIn" style=" color: #333; max-width: 430px; line-height: 1.15;">Latest Sofa<br>Collections</div>
			...
			<!-- SLIDE  -->
			<li data-transition="slideup" data-slotamount="1" data-masterspeed="1500" data-delay="10000"  data-saveperformance="off"  data-title="Single Sofa" style="background-color: #E9E8E3;">
				<!-- LAYERS -->
				...
				data-endelementdelay="0.1"
				data-endspeed="1000"
				data-endeasing="Power4.easeIn" style=""><img src="{{asset('assets/images/sliders/sofa2.png')}}" alt="Sofa"></div>
				...
				data-endelementdelay="0.1"
				data-endspeed="1000"
				data-endeasing="Power4.easeIn" style=" color: #333;">Buy Stylish Sofas at Discounted Prices</div>
				...
				data-endelementdelay="0.1"
				data-endspeed="1000"
				data-endeasing="Power4.easeIn" style=" color: #333; line-height: 1.15;">Single Sofas</div>
				...
				data-endelementdelay="0.1"
				data-endspeed="1000"
				data-endeasing="Power4.easeIn" style=""><img src="{{asset('assets/images/sliders/tag.png')}}" alt="Bag"></div>
			...
			<div class="container clearfix">
				...
				<div class="col-md-8 nopadding">
					...
					<div class="col-md-6 noleftpadding bottommargin-sm">
						<a href="#"><img src="{{asset('assets/images/banners/banner-sofa-1.jpg')}}" alt="Image"></a>
					</div>

					<div class="col-md-6 noleftpadding bottommargin-sm">
						<a href="#"><img src="{{asset('assets/images/banners/banner-sofa-2.jpg')}}" alt="Image"></a>
					</div>
							...
							<div id="shop" class="shop clearfix">
								...
								<div class="product clearfix">
									<div class="product-image">
										<a href="#"><img src="{{asset('assets/images/shops/sofa3.jpg')}}" alt="Checked Short Dress"></a>
										<a href="#"><img src="{{asset('assets/images/shops/sofa4.jpg')}}" alt="Checked Short Dress"></a>
									...
									<div class="product-desc">
										<div class="product-title"><h3><a href="#">Single Sofa</a></h3></div>
								...
								<div class="product clearfix">
										...
										<div class="fslider" data-arrows="false">
											<div class="flexslider">
												<div class="slider-wrap">
													<div class="slide"><a href="#"><img src="{{asset('assets/images/shops/sofa5-1.jpg')}}" alt="Dark Brown Boots"></a></div>
													<div class="slide"><a href="#"><img src="{{asset('assets/images/shops/sofa5-2.jpg')}}" alt="Dark Brown Boots"></a></div>
												</div>
											</div>
										</div>
										<div class="product-overlay">
									...
									<div class="product-desc">
										<div class="product-title"><h3><a href="#">Sofa with Extension</a></h3></div>
			...
			<div class="section notopborder nobottomborder nomargin nopadding nobg footer-stick">
				<div class="container clearfix">
					...
					<div class="col_half nobottommargin topmargin">
						<img src="{{asset('assets/images/services/4.jpg')}}" alt="Image" class="nobottommargin">
					</div>
