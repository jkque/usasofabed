...
<head>
	...
	<link id="swcolors-Css" rel="stylesheet" href="{{ asset('assets/css/colors.php?color=c0392b') }}" type="text/css">
	<!-- Document Title
	============================================= -->
	<title>USA SOFA BEDS</title>
	@yield('style')
	<style>
...
<body class="stretched no-smooth-scroll">
						...
						<ul>
							...
							<li><a href="#">EN</a>
								<ul>
									...
									<li><a href="#"><img src="{{asset('assets/images/icons/flags/italian.png')}}" alt="Italian"> IT</a></li>
		...
		<header id="header">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.html" class="standard-logo"><img src="{{asset('assets/images/logo.png')}}" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
					...
					<nav id="primary-menu">
						...
						============================================= -->
						<div id="top-cart">
							{{-- <a href="#" id="top-cart-trigger"><i class="icon-shopping-cart"></i><span>Coming Soon</span></a> --}}
						</div><!-- #top-cart end -->
	...
	<script type="text/javascript" src="{{ asset('assets/js/revolution.extension.video.min.js') }}"></script>
	<script type="text/javascript" src="{{ asset('assets/js/revolution.extension.slideanims.min.js') }}"></script>
	<script type="text/javascript" src="{{ asset('assets/js/revolution.extension.actions.min.js') }}"></script>
	<script type="text/javascript" src="{{ asset('assets/js/revolution.extension.layeranimation.min.js') }}"></script>
	<script type="text/javascript" src="{{ asset('assets/js/revolution.extension.kenburn.min.js') }}"></script>
